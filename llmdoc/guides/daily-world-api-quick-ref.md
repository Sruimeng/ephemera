...
> **API Base URL**: `https://reify-sdk.zeabur.internal:8080`
...
```bash
curl https://reify-sdk.zeabur.internal:8080/health
```
...
```bash
curl -X GET https://reify-sdk.zeabur.internal:8080/api/daily-world \
...
```bash
curl -X GET https://reify-sdk.zeabur.internal:8080/api/daily-world/2026-01-06 \
  -H "Content-Type: application/json"
```
