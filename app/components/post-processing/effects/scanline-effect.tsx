...
export const ScanlineEffect = forwardRef<Effect, ScanlineEffectProps>(function ScanlineEffect(
  { density = 1.5, opacity = 0.02 },
  ref,
) {
  const effect = useMemo(() => new ScanlineEffectImpl({ density, opacity }), [density, opacity]);
